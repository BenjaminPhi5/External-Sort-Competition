...
public class AdaptiveSort {
    ...
    private static void sort(RandomAccessFile fis, RandomAccessFile fos, File a,
        ...
        try {
            ...
            index = readFromBuffer(boundLower, boundUpper);
    ...
    private static int readFromBuffer(int boundLower, int boundUpper) throws IOException{
        ...
        System.out.print("totalRead: "+totalRead+"\t Index at read: " + index);
        return index;
    }
